 ...
 *   2.1    → Gwdm21Handler  (extends Gwdm2xHandler; sibling of 2.0, override here when 2.1 diverges)
 *   2.2    → Gwdm22Handler  (extends Gwdm2xHandler; sibling of 2.1, override here when 2.2 diverges)
...
class GwdmHandlerFactory
{
     ...
     */
    public const SUPPORTED_VERSIONS = ['2.0', '2.1', '2.2'];
    ...
    public function resolve(string $version): GwdmMetadataHandler
    {
        return match (true) {
            ...
            $version === '2.2'                     => new Gwdm22Handler($version),
