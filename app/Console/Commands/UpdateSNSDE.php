...
class UpdateSNSDE extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:update-snsde-custodian-network';
     ...
     * @var string
     */
    protected $description = 'Update name and description of SNSDE';
    ...
    {
        $data = [
            'name' => 'The NHS Research Secure Data Environment (SDE) Network',
            'summary' => "The NHS Research Secure Data Environment (SDE) Network helps approved researchers by simplifying and accelerating secure access to the health and social care data they need. " .
            "It is designed to be the default route for accessing NHS data for research and will drive federation and interoperability in two main ways:" .
            ...
            "\n\n### Find out more" .
            "\nInformation about the services provided by members of the NHS Research SDE Network is available [here](https://digital.nhs.uk/data-and-information/research-powered-by-data/sde-network).",
        ];

        try {
            $snsde = DataProviderColl::where('name', 'like', '%SDE%')->first();
            if ($snsde) {
                $snsde->name = $data['name'];
