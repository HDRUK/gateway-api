...
class CollectionController extends Controller
{
     ...
     *          @OA\Property(property="data", ref="#/components/schemas/Collection"),
     *       ),
     *    ),
     * )
     */
     ...
     *             @OA\Property(property="datasets", type="array", example="[]", @OA\Items(type="object", @OA\Property(property="id", type="integer"), @OA\Property(property="reason", type="string"))),
     *             @OA\Property(property="tools", type="array", example="[]", @OA\Items(type="object", @OA\Property(property="id", type="integer"), @OA\Property(property="reason", type="string"))),
     *             @OA\Property(property="dur", type="array", example="[]", @OA\Items(type="object", @OA\Property(property="id", type="integer"), @OA\Property(property="reason", type="string"))),
     *             @OA\Property(property="publications", type="array", example="[]", @OA\Items(type="object", @OA\Property(property="id", type="integer"), @OA\Property(property="reason", type="string"))),
     *             @OA\Property(property="collaborators", type="array", example="[]", @OA\Items(type="integer")),
