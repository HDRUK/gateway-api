...
class DurController extends Controller
{
     ...
     *             @OA\Items(ref="#/components/schemas/Dur"),
     *          ),
     ...
     *          @OA\Schema(
     *             @OA\Property(property="non_gateway_datasets", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="non_gateway_applicants", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="funders_and_sponsors", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="other_approval_committees", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="gateway_outputs_tools", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="gateway_outputs_papers", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="non_gateway_outputs", type="array", example="[]", @OA\Items(type="string")),
     ...
     *             )),
     *             @OA\Property(property="publications", type="array", example="[]", @OA\Items(type="object",
     *                @OA\Property(property="id", type="integer", example=1),
     *                @OA\Property(property="reason", type="string", example=""),
     *                @OA\Property(property="user_id", type="integer", example=1),
     *             )),
     *             @OA\Property(property="keywords", type="array", example="[]", @OA\Items(type="string")),
     *             @OA\Property(property="users", type="array", example="[]", @OA\Items(type="object",
     *                @OA\Property(property="id", type="integer", example=1),
     *                @OA\Property(property="firstname", type="string", example="Jane"),
     *                @OA\Property(property="lastname", type="string", example="Doe"),
     *             )),
     *             @OA\Property(property="user", type="array", example="{}", @OA\Items(type="object",
     *                @OA\Property(property="id", type="integer", example=1),
     *                @OA\Property(property="firstname", type="string", example="Jane"),
     *                @OA\Property(property="lastname", type="string", example="Doe"),
     *             )),
     *             @OA\Property(property="team", type="array", example="{}", @OA\Items(type="object",
     *                @OA\Property(property="id", type="integer", example=1),
     *                @OA\Property(property="name", type="string", example=""),
     *                @OA\Property(property="team_logo", type="string", example="/teams/nhse.png"),
     *                @OA\Property(property="member_of", type="string", example=""),
     *                @OA\Property(property="contact_point", type="string", example="contact@nhsengland.nhs.uk"),
     *             )),
     ...
     *           @OA\Property(property="message", type="string", example="success"),
     *              @OA\Property(
     *                 property="data", ref="#/components/schemas/Dur",
     *              ),
     *        ),
     *    ),
     *      @OA\Response(
     ...
     *    operationId="export_dur_template",
     *    tags={"Data Use Registers"},
