...
class DatasetStructuralMetadataExportTest extends TestCase
{
    public function test_generates_excel_dataset_structural_metadata_download_type_table(): void
    {
        ...
        $export = Arr::has($testData, 'versions.0.metadata.metadata.structuralMetadata') ? 
            $testData['versions'][0]['metadata']['metadata']['structuralMetadata'] : 
            [];
            ...
            [
                ...
                "metadata" => [
                    "metadata" => [
                        ...
                        "structuralMetadata" => [
                            [
                                "name" => "BathTAP Headache 2",
                                "description" => null,
                                "columns" => [
                                    [
                                        "name" => "Dual_NoPain_Lines_ACC",
