...
class DataUseRegisterIntegrationTest extends TestCase
{
    ...
    public function test_get_data_use_register_by_id_with_success(): void
    {
        ...
        $response = $this->json('GET', self::TEST_URL . '/'. $content['data'], $this->body, $this->header);
    ...
    public function test_update_data_use_register_with_success(): void 
    {
        ...
        $this->assertTrue(json_encode($mockDataUpdate['ro_crate']) === $responseUpdate['data']['ro_crate']);
