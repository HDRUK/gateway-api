...
class DatasetsV2HelpersTest extends TestCase
{
    ...
    public function test_it_handles_metadata_key_with_json_string()
    {
    ...
    public function test_it_handles_nested_metadata_metadata_key()
    {
        $result = $this->extractMetadata([
            'metadata' => [
                'metadata' => ['foo' => 'bar']
    ...
    public function test_it_handles_invalid_json_gracefully()
    {
        $invalidJson = '{"foo":"bar"';
    ...
    public function test_it_returns_metadata_as_is_if_already_array()
    {
        $input = ['metadata' => ['foo' => 'bar']];
        $result = $this->extractMetadata($input);
