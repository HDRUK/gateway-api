...
return [
    ...
    [
        'name' => 'dar-access-applications.show',
        'method' => 'get',
        'path' => 'dar-access-applications/{id}',
    ...
    [
        'name' => 'dar-access-applications.edit',
        'method' => 'patch',
        'path' => 'dar-access-applications/{id}',
    ...
    [
        'name' => 'dar-access-applications.update',
        'method' => 'put',
        'path' => 'dar-access-applications/{id}',
    ...
    [
        'name' => 'dar-access-applications.create',
        'method' => 'post',
        'path' => 'dar-access-applications',
    ...
    [
        'name' => 'dar-access-applications.destroy',
        'method' => 'delete',
        'path' => 'dar-access-applications/{id}',
    ...
    [
        'name' => 'dar-application-answers.index',
        'method' => 'get',
        'path' => 'dar-application-answers',
        'methodController' => 'DataAccessApplicationAnswerController@index',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
    [
        'name' => 'dar-application-answers.show',
        'method' => 'get',
        'path' => 'dar-application-answers/{id}',
        'methodController' => 'DataAccessApplicationAnswerController@show',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
    [
        'name' => 'dar-application-answers.edit',
        'method' => 'patch',
        'path' => 'dar-application-answers/{id}',
        'methodController' => 'DataAccessApplicationAnswerController@edit',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
    [
        'name' => 'dar-application-answers.update',
        'method' => 'put',
        'path' => 'dar-application-answers/{id}',
        'methodController' => 'DataAccessApplicationAnswerController@update',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
    [
        'name' => 'dar-application-answers.create',
        'method' => 'post',
        'path' => 'dar-application-answers',
        'methodController' => 'DataAccessApplicationAnswerController@store',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
    [
        'name' => 'dar-application-answers.destroy',
        'method' => 'delete',
        'path' => 'dar-application-answers/{id}',
        'methodController' => 'DataAccessApplicationAnswerController@destroy',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => ['jwt.verify'],
        'constraint' => [],
    ],
