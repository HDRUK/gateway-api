...
return [
    ...
    [
        ...
        'method' => 'get',
        'path' => '/datasets/pids',
        'methodController' => 'DatasetController@getAllDatasetPids',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [],
    ],
    [
        'name' => 'datasets',
        'method' => 'get',
        'path' => '/metadata/linkages',
        'methodController' => 'DatasetController@getAllDatasetLinkages',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [],
    ],
    [
        'name' => 'datasets',
        'method' => 'put',
        'path' => '/metadata/linkages/{pid}',
        'methodController' => 'DatasetController@updateMetadataLinkages',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [],
    ],
    [
        'name' => 'datasets',
        'method' => 'get',
        'path' => '/metadata/titles',
        'methodController' => 'DatasetController@getAllDatasetTitles',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [],
    ],
    ...
    [
        'name' => 'datasets',
        'method' => 'get',
        'path' => '/team/{id}/datasets',
        'methodController' => 'DatasetController@teamDatasetIds',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [
            'id' => '[0-9]+',
    ...
    [
        ...
        'method' => 'get',
        'path' => '/metadata/{pid}',
        'methodController' => 'DatasetController@metadataByPid',
        'namespaceController' => 'App\Http\Controllers\Api\V1',
        'middleware' => [],
        'constraint' => [],
    ],
