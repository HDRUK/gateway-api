...
return [
    ...
    'facet_map' => [
        'datasets'                => 'publisherName,keywords,dataType,dataSubType,geographicLocation,formatAndStandards,accessService,containsBioSamples,sampleAvailability,isCohortDiscovery,dataProviderColl,collectionNames,dataUseTitles,duoCodes',
    ...
    'filterable_map' => [
        'datasets'                => ['publisherName', 'keywords', 'dataType', 'dataSubType', 'geographicLocation', 'formatAndStandards', 'accessService', 'containsBioSamples', 'sampleAvailability', 'isCohortDiscovery', 'dataProviderColl', 'collectionNames', 'dataUseTitles', 'duoCodes', 'startDate', 'endDate'],
        'tools'                   => ['license', 'programmingLanguages', 'typeCategory'],
        'collections'             => ['publisherName', 'datasetTitles', 'dataProviderColl'],
        'dur'                     => ['publisherName', 'sector', 'datasetTitles', 'collectionNames', 'dataProviderColl', 'accessType'],
        'publications'            => ['publicationType', 'datasetTitles', 'datasetLinkTypes'],
