...
class CancerTypeFilterSeeder extends Seeder
{
     ...
     *
     * Usage:
     * 1. Default: tests/Unit/test_files/cancer_type_filters.json (project root)
     * 2. Or place a copy at storage/app/cancer_type_filters.json
    ...
    {
        $candidates = [
            base_path('tests/Unit/test_files/cancer_type_filters.json'),
            storage_path('app/cancer_type_filters.json'),
        ];
