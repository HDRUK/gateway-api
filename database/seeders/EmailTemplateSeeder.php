    ...
    public function run(): void
    {
          ...
          'buttons' => '
            {
                "replacements": [
                    {
                        "placeholder": "[[BUTTON_1_URL]]",
                        "actual": "env(gateway.gateway_url)/en/account/team/[[TEAM_ID]]/integrations/integration"
                    }
                ]
            }
          '
        ...
        'buttons' => '
        {
            "replacements": [
                {
                    "placeholder": "[[BUTTON_1_URL]]",
                    "actual": "env(gateway.gateway_url)/en/account/team/[[TEAM_ID]]/datasets"
                }
            ]
        }
        '
        ...
        EmailTemplate::create([
            ...
            'buttons' => '
            {
                "replacements": [
                    {
                        "placeholder": "[[BUTTON_1_URL]]",
                        "actual": "env(gateway.gateway_url)/en/account/team/[[TEAM_ID]]/integrations/api-management"
                    }
                ]
            }
            '
            ...
            'buttons' => '
                {
                    "replacements": [
                        {
                            "placeholder": "[[BUTTON_1_URL]]",
                            "actual": "env(gateway.gateway_url)/en/account/team/[[TEAM_ID]]/integrations/integration/list"
                        }
                    ]
                }
            ',
            ...
            'buttons' => '
                {
                    "replacements": [
                        {
                            "placeholder": "[[BUTTON_1_URL]]",
                            "actual": "env(gateway.gateway_url)/en/account/team/[[TEAM_ID]]/data-access-requests/applications"
                        }
                    ]
                }
            '
            ...
            'buttons' => '
                {
                    "replacements": [
                        {
                            "placeholder": "[[BUTTON_1_URL]]",
                            "actual": "env(gateway.gateway_url)/en/account/data-access-requests"
                        }
                    ]
                }
            '
